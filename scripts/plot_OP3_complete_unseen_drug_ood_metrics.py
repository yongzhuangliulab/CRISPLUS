...
METHODS = [
    {
        "name": "CRISPLUS",
        "root": Path("../results/OP3_complete_unseen_drug"),
        "run_prefix": "OP3_complete_unseen_drug",
        "color": "#d95f4a",
    },
    {
        "name": "CRISP",
        "root": Path("../results/OP3_complete_unseen_drug_CRISP"),
        "run_prefix": "OP3_complete_unseen_drug",
        "color": "#4c78a8",
    },
    {
    ...
    {
        "name": "CRISPLUSv0.3",
        "root": Path("../results/OP3_complete_unseen_drug_CRISPLUSv0.3"),
        "run_prefix": "OP3_complete_unseen_drug",
        "color": "#72b7b2",
    },
    {
        "name": "CRISPLUSv0.4",
        "root": Path("../results/OP3_complete_unseen_drug_CRISPLUSv0.4"),
        "run_prefix": "OP3_complete_unseen_drug",
        "color": "#eeca3b",
    },
]
...
FIGURE_DIR = Path("../figures/OP3_complete_unseen_drug")
...
def parse_split_seed_from_dirname(dirname: str, run_prefix: str):
    """
    解析目录名:
        OP3_complete_unseen_drug_split1_1327
...
def plot_ood_boxplot_multi_methods(df: pd.DataFrame):
    ...
    fig.text(
        0.02,
        0.5,
        "OP3_complete unseen cell type & drug",
        rotation=90,
        va="center",
        fontsize=13,
    )
